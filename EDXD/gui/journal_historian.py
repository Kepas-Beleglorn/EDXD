...
from EDXD.globals import CACHE_DIR, logging, log_context, JOURNAL_TIMESTAMP_FILE, DEFAULT_HEIGHT_JH, DEFAULT_WIDTH_JH, DEFAULT_POS_Y, DEFAULT_POS_X, RESIZE_MARGIN, DEFAULT_WINDOW_SHOW
...
class JournalHistorian(DynamicFrame):
    def __init__(self, journal_reader: JournalReader, journal_controller:JournalController, status_json_watcher: StatusWatcher):
        ...
        self._props = WindowProperties.load(WINID, default_height=DEFAULT_HEIGHT_JH, default_width=DEFAULT_WIDTH_JH,
