...
class PositionTracker(DynamicDialog):
    def __init__(self, parent, title=TITLE, win_id=WINID):
        ...
        props = WindowProperties.load(win_id, default_height=DEFAULT_HEIGHT_PSPS, default_width=DEFAULT_WIDTH_PSPS, default_posx=DEFAULT_POS_X, default_posy=DEFAULT_POS_Y, default_is_hidden=False)
        ...
        self.buttons = PSPSButtons(parent=self.scroll_container)
